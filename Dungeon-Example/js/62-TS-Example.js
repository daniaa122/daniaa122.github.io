...
function generateMonster() {
    ...
    console.log(monsterArray[monsterArray.length - 1]); // Man kann nur auf Array-Teile zugreifen, welche definiert sind. -1 ist nicht definitiert (und wird es auch nie sein).

...
let playerName : string = "Dan der boy";                                            // Ein paar globale Variablen, welche den Spieler darstellen.
let playerXP : number = 0;                                                          // Fehler1  Stellt die gesammelte Erfahrung des Spielers dar.
...
// ----------- Funktionen ----------- //
// INSGESAMT EINGEBAUTE FEHLER bei den Funktionen: IIIII (5 / fünf)  gefunden : 1/5
...
//console.log(document.getElementById("monsterSpawner").innerHTML);                 //Fehler Wozu?
...
function generateMonster()
{
   ...
   console.log(monsterArray[monsterArray.length-1].monsterHealthPoints);                    //TEST  Man kann nur auf Array-Teile zugreifen, welche definiert sind. -1 ist nicht definitiert (und wird es auch nie sein).
...
function generateMonsterXP() : number
{
    ...
    let tempMonsterXP  = 100 + getRNGNumber(350);                           //Fehler?
